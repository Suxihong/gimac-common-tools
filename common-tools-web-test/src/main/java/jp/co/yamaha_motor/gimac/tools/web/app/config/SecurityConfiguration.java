package jp.co.yamaha_motor.gimac.tools.web.app.config;

import jp.co.yamaha_motor.gimac.tools.web.app.config.auth.DummyAuthenticationInterceptor;
...
import jp.co.yamaha_motor.gimac.tools.web.app.config.auth.PJUserDetailsServiceLoader;
...
public class SecurityConfiguration {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return web -> web.ignoring().requestMatchers("/**/webjars/**", "/**/resources/**", "/**/ynawebjars/**", "/**/public/**", "/**/static-res/**");
    }
    ...
    protected class DummySecurity implements WebMvcConfigurer {
        ...
        public void addInterceptors(InterceptorRegistry registry) {
            registry.addInterceptor(dummyAuthenticationInterceptor()).addPathPatterns("/**");
        }
